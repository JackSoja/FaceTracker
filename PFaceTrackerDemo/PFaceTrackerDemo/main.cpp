...
//    }
    ...
    for(i = 0; i < n; i++){
        ...
        c = CV_RGB(0,0,255); cv::circle(image,p1,2,c);
    }return;
}
//=============================================================================
              ...
              bool &fcheck,double &scale,int &fpd)
{
    ...
    for(i = 1; i < argc; i++){
        if(std::strcmp(argv[i],"-s") == 0){
            if(argc > i+1)scale = std::atof(argv[i+1]); else scale = 0.4;
            break;
        }
    }
    if(i >= argc)scale = 0.6;
    ...
    for(i = 1; i < argc; i++){
        if(std::strcmp(argv[i],"-m") == 0){
            ...
            else strcpy(ftFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face2.tracker");
            break;
        }
    }
    if(i >= argc)std::strcpy(ftFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face2.tracker");
    for(i = 1; i < argc; i++){
        if(std::strcmp(argv[i],"-c") == 0){
            if(argc > i+1)std::strcpy(conFile,argv[i+1]);
            else strcpy(conFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face.con");
            break;
        }
    }
    if(i >= argc)std::strcpy(conFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face.con");
    for(i = 1; i < argc; i++){
        if(std::strcmp(argv[i],"-t") == 0){
            if(argc > i+1)std::strcpy(triFile,argv[i+1]);
            else strcpy(triFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face.tri");
            break;
        }
    }
    if(i >= argc)std::strcpy(triFile,"/Users/itaa/Documents/MYCode/FaceLandmark/FaceTracker/model/face.tri");
    return 0;
}
//=============================================================================
...
//            t.StartTimer(3000, std::bind(resetFrame, aa));
//        }
//        a = 1;
